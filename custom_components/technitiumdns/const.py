...
SENSOR_TYPES = {
    ...
    "server_failure": {
        "name": "Total Server Failure",
        "state_class": "measurement",
        "device_class": "count",
    },
    "nx_domain": {
        "name": "Total NX Domain",
        "state_class": "measurement",
        "device_class": "count",
    },
    "refused": {
    ...
    "authoritative": {
        "name": "Total Authoritative",
        "state_class": "measurement",
        "device_class": "count",
    },
    "recursive": {
        "name": "Total Recursive",
        "state_class": "measurement",
        "device_class": "count",
    },
    "cached": {
    ...
    "allow_list_zones": {
        "name": "Allow List Zones",
        "state_class": "measurement",
        "device_class": "count",
    },
    "block_list_zones": {
        "name": "Block List Zones",
        "state_class": "measurement",
        "device_class": "count",
    },
...
DEFAULT_ACTIVITY_ANALYSIS_WINDOW = (
    120  # Minutes to analyze for activity patterns (2 hours)
)
