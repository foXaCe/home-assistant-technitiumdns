...
- **Cluster mode** — when enabled, statistics are fetched with `node=cluster` for aggregate cluster stats (see [issue #76](https://github.com/Amateur-God/home-assistant-technitiumdns/issues/76))
